...
export default async function decorate(block) {
    const countriesBlock = block.querySelector('a[href$=".json"]');
    ...
    if (countriesBlock) {
        ...
        const initialContent = await createDivStructure(countriesBlock.href, 0, 20);
        contentContainer.append(initialContent);
        createPaginationControls(contentContainer, countriesBlock.href, 0, 20);

        countriesBlock.replaceWith(parentDiv);
    }
}
